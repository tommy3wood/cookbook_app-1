...
Recipe.create!([
  ...
  {title: "Big Mac", ingredients: "two all beef paddies, lettuce, onions, pickles, cheese, special sauce, seaseme bun", directions: "drive to Mcdonald's, order burger from fiberglass clown, pull up to the window, exchange burger for money", image_url: "http://www.dreadcentral.com/wp-content/uploads/2017/03/mactonightbanner.jpg", prep_time: 5, user_id: 1},
  ...
  {title: "spam", ingredients: "can, key, meat", directions: "twist key, open can, enjoy", image_url: nil, prep_time: 14, user_id: 2},
  {title: "Maple Simple Syr", ingredients: "tree, tap", directions: "tap the sap, collect bucket", image_url: "https://cdn.shopify.com/s/files/1/0262/3940/2077/products/macs-maple-syrup-glass-leaf-bottle-bag-3_1200x1200.jpg?v=1565371649", prep_time: 360, user_id: 1}
])
